 ...
 */
export function PersonAvatar({ userId, name, avatar, size = 40, online, isMe = false, className, wrapClassName }: {
  userId?: string;
  name: string;
  avatar?: string | null;
  size?: number | "fill";
  ...
  return <AvatarArt value={value} size={size} online={online} className={className} wrapClassName={wrapClassName} />;
}
