...
const base = (color = "currentColor", sw = 2) => ({
  stroke: color,
  strokeWidth: sw,
...
export const Icon = {
  ...
  settings: ({ size, color = "currentColor", strokeWidth }: P) => (
  ...
  edit: ({ size, color = "currentColor", strokeWidth }: P) => (
  ...
  apple: ({ size = 18, color = "currentColor" }: P) => (
  ...
  star: ({ size, color = "var(--accent)", fill = "var(--accent-soft)" }: P) => (
  ...
  lightning: ({ size, color, fill = "var(--accent)" }: P) => (
  ...
  bell: ({ size, color = "currentColor" }: P) => (
  ...
  cam: ({ size, color = "currentColor", strokeWidth }: P) => (
